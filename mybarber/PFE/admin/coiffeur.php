...
<body id="body-pd">
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div>
                <div class="nav_list">
                    <a href="./admin.php" class="nav_link "> <i class='bx bx-grid-alt nav_icon'></i>
                        <span class="nav_name">Dashboard</span>
                    </a>
                    <a href="coiffeur.php" class="nav_link active">
    ...
    switch ($source) {
        case 'add_coi';
            include "includes/addcoiffeur.php";
            break;
        case 'update_coi';

            include "includes/updatecoiffeur.php";
            break;
        default:
            include "includes/coiffeur.php";
            break;
    }
